        ...
        985: function(t, e, i) {
            ...
            function b(t, e) {
                if (t) {
                    ...
                    return "Object" === i && t.constructor && (i = t.constructor.name), "Map" === i || "Set" === i ? Array.from(t) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? w(t, e) : void 0
                }
            }
            ...
            function K(t) {
                ! function(t) {
                    ...
                    if (0 === e.length)
                        for (var i in t) H.call(t, i) && "function" == typeof t[i] && "[object Function]" == W.call(t[i]) && e.push(i);
                    ...
                    useKeyboard: !0,
                    useTouch: !0
                }, t), this.options.limitInertia && (this._lethargy = new P), this._emitter = new j, this._event = {
                    y: 0,
                    x: 0,
                    deltaX: 0,
                    deltaY: 0
            ...
            K.prototype._notify = function(t) {
                var e = this._event;
                e.x += e.deltaX, e.y += e.deltaY, this._emitter.emit(Y, {
                    x: e.x,
                    y: e.y,
                    deltaX: e.deltaX,
                    deltaY: e.deltaY,
                ...
                if (!this._lethargy || !1 !== this._lethargy.check(t)) {
                    var i = this._event;
                    i.deltaX = t.wheelDeltaX || -1 * t.deltaX, i.deltaY = t.wheelDeltaY || -1 * t.deltaY, _.isFirefox && 1 == t.deltaMode && (i.deltaX *= e.firefoxMultiplier, i.deltaY *= e.firefoxMultiplier), i.deltaX *= e.mouseMultiplier, i.deltaY *= e.mouseMultiplier, this._notify(t)
                }
            ...
            function et(t, e, i) {
                return ((Q(e, i) * t + Z(e, i)) * t + tt(e)) * t
            }

            function it(t, e, i) {
                return 3 * Q(e, i) * t * t + 2 * Z(e, i) * t + tt(e)
            }
            ...
            var nt = function(t, e, i, s) {
                    ...
                    if (t === e && i === s) return st;
                    for (var n = J ? new Float32Array(11) : new Array(11), o = 0; o < 11; ++o) n[o] = et(o * G, t, i);
                    ...
                    function l(e) {
                        ...
                        return r >= .001 ? function(t, e, i, s) {
                            ...
                            var o, l, r = 0;
                            do {
                                (o = et(l = e + (i - e) / 2, s, n) - t) > 0 ? i = l : e = l
                            } while (Math.abs(o) > 1e-7 && ++r < 10);
                            return l
                        }(e, s, s + G, t, i)
                    }
                    return function(t) {
                        return 0 === t ? 0 : 1 === t ? 1 : et(l(t), e, s)
                    }
                },
                ot = 38,
                lt = 40,
                ...
                ft = function(t) {
                    ...
                    return o(i, [{
                        ...
                        key: "updateScroll",
                        value: function(t) {
                            this.isScrolling || this.isDraggingScrollbar ? this.instance.scroll[this.directionAxis] = N(this.instance.scroll[this.directionAxis], this.instance.delta[this.directionAxis], this.lerp) : this.instance.scroll[this.directionAxis] > this.instance.limit[this.directionAxis] ? this.setScroll(this.instance.scroll[this.directionAxis], this.instance.limit[this.directionAxis]) : this.instance.scroll.y < 0 ? this.setScroll(this.instance.scroll[this.directionAxis], 0) : this.setScroll(this.instance.scroll[this.directionAxis], this.instance.delta[this.directionAxis])
                        }
                    }, {
                        key: "addDirection",
                        value: function() {
                        ...
                        value: function() {
                            ...
                            this.els = {}, this.parallaxElements = {}, this.el.querySelectorAll("[data-".concat(this.name, "]")).forEach((function(e, i) {
                                ...
                                null === r || r.inView ? (s = g.top + t.instance.scroll.y - U(o).y, n = g.left + t.instance.scroll.x - U(o).x) : (s = g.top - U(r.el).y - U(o).y, n = g.left - U(r.el).x - U(o).x);
                        ...
                        value: function() {
                            ...
                            0 === e.length && (e = [this.el]), e.forEach((function(e, i) {
                                var s = "string" == typeof e.dataset[t.name + "Id"] ? e.dataset[t.name + "Id"] : "section" + i,
                                    ...
                                    o = {
                                        x: n.left - 1.5 * window.innerWidth - U(e).x,
                                        y: n.top - 1.5 * window.innerHeight - U(e).y
                                    },
                                    l = {
                        ...
                        value: function(t) {
                            ...
                            if (o = nt.apply(void 0, y(o)), "string" == typeof t) {
                                if ("top" === t) t = 0;
                            ...
                            if ("number" != typeof t) {
                                ...
                                var c = t.getBoundingClientRect(),
                                    ...
                                    p = 0;
                                p = f ? U(f)[this.directionAxis] : -this.instance.scroll[this.directionAxis], s = "horizontal" === this.direction ? d + s - p : h + s - p
                            } else s = t + s;
                            var m = parseFloat(this.instance.delta[this.directionAxis]),
                                b = Math.max(0, Math.min(s, this.instance.limit[this.directionAxis])),
                                w = b - m,
                                g = function(t) {
                                    l ? "horizontal" === e.direction ? e.setScroll(m + w * t, e.instance.delta.y) : e.setScroll(e.instance.delta.x, m + w * t) : e.instance.delta[e.directionAxis] = m + w * t
                                };
                ...
                mt = function() {
                    function t() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                        s(this, t), this.options = e, Object.assign(this, g, e), this.smartphone = g.smartphone, e.smartphone && Object.assign(this.smartphone, e.smartphone), this.tablet = g.tablet, e.tablet && Object.assign(this.tablet, e.tablet), this.init()
                    }
                    return o(t, [{
                        key: "init",
                        value: function() {
...
//# sourceMappingURL=985.js.map?v=1742551320349